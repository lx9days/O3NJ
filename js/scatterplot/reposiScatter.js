function plotScatter(data){
	...
	var margin = {top: 10, right: 10, bottom: 30, left: 10},
		...
		height = scatterplotHeight - margin.top - margin.bottom;
	...
	var color = d3.scale.ordinal().domain(data).range(["rgba(130,146,141,0.3)"]);
	...
	svg.selectAll(".dot")
		...
		.style("fill", d => {
			// if(d.taxa == "A37" || d.taxa == "A153") {
			// 	return "rgba(0,0,0,1)"
			// }
			// if(d.taxa == "A38" || d.taxa == "A152") {
